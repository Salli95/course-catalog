  ...
  return (
    <html lang="ru">
      <body className="flex min-h-screen flex-col bg-slate-50 text-slate-800 antialiased">
        ...
        <header className="sticky top-0 z-10 border-b border-sky-100 bg-white shadow-xs">
          <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
            <Link
              href="/"
              className="flex items-center gap-2 text-lg font-bold text-slate-900 hover:text-blue-600"
              className="flex items-center gap-2 text-lg font-bold text-slate-900 hover:text-sky-600 transition"
            >
              <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-blue-600 text-sm font-black text-white">
              <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-sky-600 text-sm font-black text-white">
                CC
              </span>
            ...
            <nav className="flex items-center gap-6 text-sm font-medium">
              ...
              <Link href="/" className="text-slate-600 hover:text-sky-600 transition">
                Главная
              </Link>
              <Link href="/courses" className="text-slate-600 hover:text-blue-600">
              <Link href="/courses" className="text-slate-600 hover:text-sky-600 transition">
                Курсы
              </Link>
              <Link href="/about" className="text-slate-600 hover:text-blue-600">
              <Link href="/about" className="text-slate-600 hover:text-sky-600 transition">
                О проекте
              </Link>
            </nav>
          </div>
